<?php
/* Smarty version 4.1.0, created on 2022-04-25 12:39:06
  from 'D:\Website\homepage for LearningCurveGroup\templates\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_62667a4ae89ae5_23412712',
...
function content_62667a4ae89ae5_23412712 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="en">
...
?>
                                <div class="container-fluid container-lg my-2 my-md-5">
                                        ...
                                        <div class="row p=0 <?php echo !(1 & $_smarty_tpl->tpl_vars['i']->value) ? 'flex-row-reverse' : 'flex-row';?>
">
...
?>
                                                    <a class="text-decoration-none mb-2 mt-2" href="#">
                                                        <div class="alert alert-primary p-0 m-0 border-0 border-primary border-bottom-0 border-top-0 border-end-0 rounded-2 d-flex <?php echo !(1 & $_smarty_tpl->tpl_vars['i']->value) ? 'flex-row-reverse' : 'flex-row';?>
